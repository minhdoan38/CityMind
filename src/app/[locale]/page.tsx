...
export default async function LocalizedHomePage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <header className="sticky top-0 z-40 border-b border-border bg-card shadow-[var(--shadow-card)]">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-6 py-3">
          <Link
            href="/"
            className="inline-flex min-h-11 shrink-0 items-center gap-3 text-[1.25rem] font-semibold tracking-[-0.02em] text-foreground"
          >
            <CityMindLogo size={36} priority className="rounded-md" />
      ...
      <main className="flex flex-grow flex-col">
        ...
        <section className="relative isolate">
          <div className="relative min-h-[min(78vh,42rem)] w-full overflow-hidden">
            ...
            <div
              aria-hidden
              className="absolute inset-0 bg-gradient-to-r from-[#1e3a8a]/90 via-[#2563eb]/60 to-[#3b71f7]/35"
            />
            ...
            <div className="relative z-10 mx-auto flex min-h-[min(78vh,42rem)] max-w-6xl flex-col justify-center px-6 pb-28 pt-16 sm:pb-32">
              <div className="max-w-[34rem]">
                ...
                <h1 className="font-display hero-rise hero-rise-delay-1 mt-3 text-balance text-[clamp(2rem,5vw,3.25rem)] font-semibold leading-[1.12] tracking-[-0.03em] text-white">
                  {t("heroHeadline")}
                </h1>
